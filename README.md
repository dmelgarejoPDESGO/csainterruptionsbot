...
- Navigate to `csainterruptionsbot` folder
- Select `csainterruptionsbot.bot` file
...
msbot clone services --name "csainterruptionsbot" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
